    ...
    # If file is uploaded and form is submitted, process resume
        ...
        with screen_content_holder.container():
            ...
            with st.spinner("Processing Resume.."):
                ...
                anlyz_txt.build_word_count_features(data = [processed_text], data_type='resume', uploaded_file = uploaded_file)
            ...
            with st.spinner("Finding Matches.."):
                ...
                if os.path.exists("data//postings//Job Postings.xlsx"):
                    ...
                    st.success(':smile: Resume Features Uploaded. Matches coming soon')
                else:
